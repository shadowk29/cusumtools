...
class App(tk.Frame):
    def __init__(self, parent):
        ...
        self.default_counterion_conductance_length_label = tk.Label(self.param_frame, text='Counterion Conductance (nS\u00B7nm):')
        ...
        CreateToolTip(self.counterion_conductance_length, 'Product of linear charge density of analyte and counterion mobility (nS\u00B7nm)')
