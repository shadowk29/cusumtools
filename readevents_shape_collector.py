...
def get_files():
    ...
    while True:
        print 'Select file.\n'
        files.append(tkFileDialog.askopenfilename(initialdir='E:/DATA/2017/'))
...
def save_data(all_shapes):
        save_file = tkFileDialog.asksaveasfile(initialdir='C:\Users\BEAMISH\Documents\Nanopore files\\',mode='wb', defaultextension='.csv')
